# python debate.py -c output_qwen_3_1/checkpoint-200 -b 128 -r 1
...
TEMPLATE = "{% for message in messages[:-1] %}{% if loop.first and messages[0]['role'] != 'system' %}{{ '<|im_start|>system\nYou are a helpful assistant.<|im_end|>\n' }}{% endif %}{{'<|im_start|>' + message['role'] + '\n' + message['content']}}{{ '<|im_end|>\n' }}{% endfor %}"
