...
do
    ...
    mkdir ./results/output_qwen_4_1/checkpoint-$((STEP * i))
    cp /workspace/output_qwen_4_1/checkpoint-$((STEP * i))/result.json ./results/output_qwen_4_1/checkpoint-$((STEP * i))/result.json
done