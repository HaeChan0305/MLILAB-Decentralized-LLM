...
if __name__ == "__main__":
    ...
    with open(f"./results/output_qwen_4_{args.client1}/checkpoint-{args.checkpoint}/{prev_result_path}", "r") as file:
        client_1 = json.load(file)
        client_1_answers = [extract_answer(d['prediction']) for d in client_1]
        
    with open(f"./results/output_qwen_4_{args.client2}/checkpoint-{args.checkpoint}/{prev_result_path}", "r") as file:
    ...
    with open(f"./results/output_qwen_4_{args.client1}/checkpoint-{args.checkpoint}/pollen_test_round_{args.round}.jsonl" , encoding= "utf-8",mode="w") as file: 
